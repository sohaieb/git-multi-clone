...
.command('clone')
  ...
  .option('--file', 'set a custom repositories json file path',join('.','repositories.json'))
  .option('--target', 'set a custom target folder where repositories will be cloned',resolve('.','output'))
